...
if __name__ == '__main__':
    ...
    datas = pd.read_excel('数据-1-4.xlsx',encoding='utf-8')
...
#取test
  ...
  #########################################test2
    ...
    # i=i-1
    # j=j-1
    # while int(test_nodata)<=i:
    #       if int(test_yesdata)<=j:
...
#################################################test3     
    ...
    # i=i-1
    # j=j-1
    # while 2*int(test_nodata)<=i:
    #       if 2*int(test_yesdata)<=j:        
    #           yesdata.pop(j)      
    #           nodata.pop(i)
    #       else:           
    #           nodata.pop(i)  
...
# ####################################################test4
    ...
    # i=i-1
    # j=j-1
    # while 3*int(test_nodata)<=i:
    #       if 3*int(test_yesdata)<=j:        
    #           yesdata.pop(j)      
    #           nodata.pop(i)
    #       else:           
    #           nodata.pop(i)  
...
# #############################################test5
    i=4*int(test_nodata)
    j=4*int(test_yesdata)
    test_data=[]
    
    while 4*int(test_nodata)<=i<len(nodata):
        if 4*int(test_yesdata)<=j<len(yesdata):
            print(i)
            print(j)
            print(yesdata[j],nodata[i])
            line=str(yesdata[j])+'\t'+'1'
    ...
    i=i-1
    j=j-1
    while 4*int(test_nodata)<=i:
          if 4*int(test_yesdata)<=j:
 ...
 #取dev放入校验集dev_data列表
   ...
   ################################################4
    ...
    #这一行将剩余yes类扩展了5倍存入了列表yesdata_deal，过采样

    
   # yesdata=yesdata+yesdataa#去掉回译
    
    yesdata_deal = [val for val in yesdata for i in range(4)]
   ...
   #2轮以下
    ...
    # yesdata_deal = [val for val in yesdata for i in range(2)]
